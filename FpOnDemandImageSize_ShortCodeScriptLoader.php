...
include_once('FpOnDemandImageSize_ShortCodeLoader.php');
 ...
 */
abstract class FpOnDemandImageSize_ShortCodeScriptLoader extends FpOnDemandImageSize_ShortCodeLoader {
