...
function FpOnDemandImageSize_init($file) {

    require_once('FpOnDemandImageSize_Plugin.php');
    $aPlugin = new FpOnDemandImageSize_Plugin();
...
function fpimagesize($url, $width,$height,$crop) {
